...
class Snake():
    ...
    def __init__(self, color):
        self.color = color
        self.length = 2
        self.speed = 5                                      # The snake's current speed. will be able to decide how much an snake moves in a frame by this. the tempo will be decided by the fps.
        self.pos = [(50+x,50) for x in range(10,0,-1)]                         # Array of tuples concerning what positions the snake is currently occupying.
